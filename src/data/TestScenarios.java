...
public class TestScenarios {
    ...
    public static void validNonShippableOnly() {
        System.out.println("\n****************************************");
    ...
    public static void validMixedProducts() {
        System.out.println("\n******************************************************");
    ...
    public static void invalidZeroQuantity(){
        System.out.println("\n*******************************");
    ...
    public static void invalidUnavailableQuantity() {
        System.out.println("\n**********************************************");
    ...
    public static void invalidEmptyCart() {
        System.out.println("\n****************************");
    ...
    public static void invalidInsufficientBalance() {
        System.out.println("\n**************************************");
    ...
    public static void invalidExpiredProduct() {
        System.out.println("\n***********************************");
